...
RUN mkdir -p /usr/src/undp_bougainville
...
COPY . /usr/src/undp_bougainville/
WORKDIR /usr/src/undp_bougainville
...
RUN chmod +x /usr/src/undp_bougainville/tasks.py \
    && chmod +x /usr/src/undp_bougainville/entrypoint.sh
...
ENTRYPOINT /usr/src/undp_bougainville/entrypoint.sh
