...
echo "-----------------------------------------------------"
echo "STARTING undp_bougainville RESTORE $(date)"
echo "-----------------------------------------------------"
...
SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./undp_bougainville/br/backup.sh $BKP_FOLDER_NAME/$NEW_UUID
...
echo "-----------------------------------------------------"
echo " - Original Backup of $TARGET_URL --> /$BKP_FOLDER_NAME/$NEW_UUID/"
echo "FINISHED undp_bougainville RESTORE $(date)"
echo "-----------------------------------------------------"
